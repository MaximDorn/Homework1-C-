...
string coordYline = inputLine.Substring(inputLine.IndexOf(";") + 1, inputLine.IndexOf(";"));
coordYline = coordYline.Substring(coordYline.IndexOf("=") + 1);

string coordZline = inputLine.Substring(inputLine.IndexOf(";") + 1);
coordZline = coordZline.Substring(coordZline.IndexOf("=") + 1);

Console.Write(coordXLine + " " + coordYline + " " + coordZline);
